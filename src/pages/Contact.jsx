            ...
            >
              ...
              <div className="space-y-8">
                <div className="flex items-start gap-4">
                  <Mail className="h-12 w-12 text-slate-300 stroke-[1] flex-shrink-0" />
                  <div>
                ...
                <div className="flex items-start gap-4">
                  <Phone className="h-12 w-12 text-slate-300 stroke-[1] flex-shrink-0" />
                  <div>
                ...
                <div className="flex items-start gap-4">
                  <Clock className="h-12 w-12 text-slate-300 stroke-[1] flex-shrink-0" />
                  <div>
